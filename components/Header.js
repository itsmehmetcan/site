...
const items = [
    ...
    { icon: 'fab fa-twitch', link: 'https://twitch.com/itslimon2k' },
    { icon: 'fab fa-discord', link: 'https://discord.com/users/389788999499382785' },
    { icon: 'fab fa-instagram', link: 'https://instagram.com/kaygusuzmehmetcan' },
    //{ icon: 'fab fa-facebook', link: 'https://facebook.com/umutxyp' },
    { icon: 'fab fa-github', link: 'https://github.com/mehmetcankaygusuz' },
  ]
...
const navItems = [
    ...
    { icon: 'fal fa-rss', active: 'fa fa-rss', label: 'Blogs', href: 'https://blog.mehmetcankaygusuz.com' }
]
    ...
    return <>
        <div className="w-full border-b-2 border-neutral-800/20 pb-2">
            <div className="flex flex-col md:flex-row w-full items-center md:justify-between">
                <p className="font-semibold font-Poppins text-xl">limon</p>
