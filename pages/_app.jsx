...
function MyApp({ Component, pageProps }) {
  ...
  return (<>
    <Head>
        <title>Mehmetcan Kayugusz</title>
        <link rel="shortcut icon" href="buraya" type="image/x-icon" ></link>
        ...
        <div style={{ zIndex: 99999 }} className="fixed bg-black/75 w-full h-screen flex justify-center items-center pointer-events-none">
            <div className="flex items-center gap-x-6 animate-pulse">
                <div className="text-center">
                    <p className="text-6xl mb-5 font-semibold">Mehmetcan Kaygusuz</p>
        ...
        <div className="max-w-screen-lg p-5 w-full md:w-10/12 lg:w-8/12 mx-auto transition-all duration-300">
          <div className="md:flex w-full items-center justify-between">
            ...
            <div className="mt-2 md:mt-0 flex items-center">
              <a href="https://discord.gg/limon" target="_blank" rel="noreferrer" className="w-full md:w-auto bg-neutral-700/5 hover:bg-neutral-700/20 px-4 py-2 rounded-md transition-all duration-200">
                <i className="fab fa-discord mr-2" />Discord Adresimize Katılabilirsiniz.
              </a>
            </div>
